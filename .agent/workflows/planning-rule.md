...
3.  **Validate**: Use `notify_user` to present the plan to the USER.
4.  **Wait**: You MUST receive explicit approval from the USER before proceeding to the EXECUTION phase.
