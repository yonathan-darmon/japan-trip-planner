import { Component, Input, OnInit, OnDestroy, PLATFORM_ID, Inject, AfterViewInit, ElementRef, ViewChild } from '@angular/core';
...
export class BudgetChartComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngAfterViewInit(): void {
        if (isPlatformBrowser(this.platformId) && this.budgetData && this.budgetData.totalEur > 0) {
            this.createChart();
        }
    }
    ...
    private createChart(): void {
        if (!this.chartCanvas || !this.budgetData) {
            return;
        }
